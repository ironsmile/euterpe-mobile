...
export class AlbumBig extends React.PureComponent {
  ...
  _renderItem = ({ item, index }) => (
    <QueueItem onPressSong={this._onPressSong} id={item.id} index={index} song={item} />
  );
        ...
        <View style={styles.headerTextContainer}>
          ...
          >
            <View style={styles.addToQueueButton}>
              <PlatformIcon platform="list" size={22} style={styles.addToQueueButtonIcon} />
              <Text style={styles.addToQueueButtonText}>Append In Play Queue</Text>
            </View>
          </TouchableOpacity>
