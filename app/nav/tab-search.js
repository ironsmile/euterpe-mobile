...
export function SearchNavigator() {
  return (
    <Stack.Navigator initialRouteName="Results" headerMode="none">
      ...
      <Stack.Screen name="ArtistsResults" component={SearchArtists} />
      <Stack.Screen name="AlbumsResults" component={SearchAlbums} />
      <Stack.Screen name="SongsResults" component={SearchSongs} />
    </Stack.Navigator>
  );
}
