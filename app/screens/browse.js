...
export class BrowseScreen extends React.PureComponent {
  getArtistsIcon() {
    return (
      <PlatformIcon style={styles.sectionIcon} platform="mic-outline" color="#aeafb3" size={30} />
    );
  }
  ...
  render() {
    return (
      <Screen title="BROWSE" navigation={this.props.navigation}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={styles.headerAvoider} />

          <View style={styles.encouragmentContainer}>
            <Text style={styles.subduedText}>
              Not sure what exactly do you feel like listening to? I have an advice for you. Just
              browse around your music and in no time you will find something. Promise!
            </Text>
          </View>
          ...
          <View style={styles.encouragmentContainer}>
            <Text style={styles.subduedText}>
              Don't feel like going through all of your music? No problem with that! Try searching:
            </Text>
          </View>
